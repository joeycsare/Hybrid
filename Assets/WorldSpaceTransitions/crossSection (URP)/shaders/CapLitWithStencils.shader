Shader "CrossSectionURP/Cap/LitWithStencils"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_PIE CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX CLIP_CORNER CLIP_SPHERE_OUT
