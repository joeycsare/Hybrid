...
Shader "CrossSection/Standard (Specular setup)"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_PIE CLIP_BOX CLIP_SPHERES CLIP_CORNER
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_PIE CLIP_BOX CLIP_SPHERES CLIP_CORNER // to get enumerated keywords as local.#pragma shader_feature_local RETRACT_BACKFACES
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_PIE CLIP_BOX CLIP_SPHERES CLIP_CORNER
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_PIE CLIP_BOX CLIP_SPHERES CLIP_CORNER // to get enumerated keywords as local.
			#include "CGIncludes/UnityStandardCoreForward_CS.cginc"
