...
Shader "CrossSection/Autodesk Interactive/Box"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ CLIP_BOX CLIP_PLANE CLIP_PIE CLIP_CORNER
			//#pragma multi_compile_local __ CLIP_BOX // to get enumerated keywords as local.
