...
Shader "CrossSection/Autodesk Interactive"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_PIE CLIP_CUBOID CLIP_SPHERE CLIP_CORNER
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_PIE CLIP_CUBOID CLIP_SPHERE CLIP_CORNER // to get enumerated keywords as local.
