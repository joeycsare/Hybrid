Shader "CrossSection/Surface/Box" {
	Properties{
	...
	SubShader {
		Tags {"RenderType" = "Clipping" "Queue" = "Geometry"}
		LOD 200
	...
	#pragma multi_compile __ CLIP_BOX CLIP_PIE
	//#pragma multi_compile_local __ CLIP_BOX CLIP_PIE // to get enumerated keywords as local.
